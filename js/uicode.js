...
Vue.component("metric-popup", {
  ...
  "template": "<div v-bind:id=\"metric.popupKey\" class=\"modal popup_div metric_popup_div\" tabindex=\"-1\" role=\"dialog\">"
            ...
            + "<div class=\"input-group-prepend\"><div class=\"input-group-text\"><label class=\"metric_popup_label\" for=\"input_metric_name\">Name</label></div></div>"
            + "<input type=\"text\" id=\"input_metric_name\" class=\"popup_input\" v-model=\"metric.name\" />"
            + "</div>"
            + "<div class=\"input-group\">"
            + "<div class=\"input-group-prepend\"><div class=\"input-group-text\"><label class=\"metric_popup_label\">Farbe</label></div></div>"
            + "<canvas class=\"popup_colorchooser\" width=\"270\" height=\"45\"></canvas>"
            + "</div>"
            + "<div class=\"input-group\">"
            + "<div class=\"input-group-prepend\"><div class=\"input-group-text\"><label class=\"metric_popup_label\" for=\"select_marker\">Symbol</label></div></div>"
...
Vue.component("configuration-popup", {
  ...
  "template": "<div class=\"modal popup_div config_popup_div\" tabindex=\"-1\" role=\"dialog\">"
            ...
            + "<div class=\"modal-body\">"
            + "<div class=\"input-group\">"
            + "<div class=\"input-group-prepend\"><div class=\"input-group-text\"><label class=\"config_popup_label\" for=\"resolution_input\">Auflösung</label></div></div>"
            + "<input type=\"range\" class=\"config_popup_slider form-control\" id=\"resolution_input\" v-model=\"uiResolution\" min=\"0\" max=\"29\" step=\"0.25\"/>"
            + "</div>"
            + "<div class=\"input-group\">"
            + "<div class=\"input-group-prepend\"><div class=\"input-group-text\"><label class=\"config_popup_label\" for=\"zoom_speed_input\">Zoom Geschwindigkeit</label></div></div>"
...
Vue.component("xaxis-popup", {
  "template": "<div class=\"modal popup_div xaxis_popup_div\" tabindex=\"-1\" role=\"dialog\">"
            ...
            + "<div class=\"modal-body\">"
            + "<div class=\"input-group\">"
            + "<div class=\"input-group-prepend\"><div class=\"input-group-text\"><label class=\"xaxis_popup_label\" for=\"start_date_time\">Anfangszeit</label></div></div>"
            + "<input type=\"date\" class=\"xaxis_date_field\" v-model=\"startDate\" v-bind:max=\"endDate\" required /><input type=\"time\" class=\"xaxis_date_field\" v-model=\"startTime\" id=\"start_date_time\" required /><br/>"
            + "</div>"
            + "<div class=\"input-group\">"
            + "<div class=\"input-group-prepend\"><div class=\"input-group-text\"><label class=\"xaxis_popup_label\" for=\"end_date_time\">Endzeit</label></div></div>"
            + "<input type=\"date\" class=\"xaxis_date_field\" v-model=\"endDate\" v-bind:min=\"startDate\" required /><input type=\"time\" class=\"xaxis_date_field\" id=\"end_date_time\" v-model=\"endTime\" required />"
            + "</div>"
            + "<div class=\"modal-footer\">"
            + "<button class=\"btn btn-primary popup_ok\">"
            + "OK"
...
Vue.component("export-popup", {
  "template": "<div class=\"modal popup_div export_popup_div\" tabindex=\"-1\" role=\"dialog\">"
            ...
            + "<div class=\"modal-body\">"
            + "<div class=\"input-group\">"
            + "<div class=\"input-group-prepend\"><div class=\"input-group-text\"><label class=\"export_popup_label\" for=\"export_width\">Breite</label></div></div>"
            + "<input type=\"number\" id=\"export_width\" class=\"export_resolution\" v-model=\"exportWidth\" />"
            + "</div>"
            + "<div class=\"input-group\">"
            + "<div class=\"input-group-prepend\"><div class=\"input-group-text\"><label class=\"export_popup_label\" for=\"export_height\">Höhe</label></div></div>"
            + "<input type=\"number\" id=\"export_height\" class=\"export_resolution\" v-model=\"exportHeight\" />"
            + "</div>"
            + "<div class=\"input-group\">"
            + "<div class=\"input-group-prepend\"><div class=\"input-group-text\"><label class=\"export_popup_label\" for=\"export_format\">Dateiformat</label></div></div>"
